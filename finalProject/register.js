...
async function register(req, res) {
    try {
        ...
        var sql = "INSERT INTO person (first_name, last_name, USER_NAME, password, person_email, new_person, city, state) VALUES ('"+ fname + "', '" + lname + "', '" + username + "', '" + password + "', '" + email + "', '" + newUser + "', '" + city + "', '" + state + "')";
